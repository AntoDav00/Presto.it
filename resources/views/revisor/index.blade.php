                            ...
                            <div class="col-md-6 d-flex flex-column">
                                <div class="card-body d-flex flex-column h-100 p-4">
                                    ...
                                    <div class="mb-2 d-flex flex-wrap">
                                        <p class="me-3 mb-1"><i class="bi bi-calendar3 me-2"></i>{{ $article_to_check->created_at->format('M d, Y') }}</p>
                                        <p class="mb-1"><i class="bi bi-tag me-2"></i>{{ __('ui.' . $article_to_check->category->category) }}</p>
                                    </div>
                                                ...
                                                <div class="bg-light bg-opacity-75 rounded p-3">
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-sm-6">
                                                            ...
                                                            @else
                                                                <p class="fst-italic text-muted small">No labels found</p>
                                                            @endif
                                                        </div>
                                                        <div class="col-sm-6">
                                                            ...
                                                            @foreach (['adult', 'medical', 'violence', 'racy', 'spoof'] as $rating)
                                                                <div class="d-flex w-75 justify-content-between align-items-center">
                                                                    <span class="text-capitalize small">{{ $rating }}</span>
                                                                    <div class="d-flex {{ $image->$rating }} justify-content-between align-items-center"></div>
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center mt-auto gap-2">
