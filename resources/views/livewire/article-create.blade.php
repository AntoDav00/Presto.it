...
<div class="mb-3">
    <input type="file" wire:model.live="temporary_images" multiple class="form-control @error('temporary_images.*') is-invalid @enderror" placeholder="{{__("ui.insertImages")}}">
    ...
    <div class="col-12">
        ...
        <div class="row border border-4 rounded shadow py-4 mb-3">
            ...
            <div class="col d-flex flex-column align-items-center my-3">
                ...
                <button type="button" class="btn btn-danger mt-2" wire:click="removeImage({{ $key }})">{{__('ui.delete')}}</button>
            </div>
            @endforeach
        </div>
    </div>
