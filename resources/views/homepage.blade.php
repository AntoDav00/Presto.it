        ...
        @foreach ($carouselSlides as $index => $slide)
            <div class="carousel-slide {{ $index === 0 ? 'active' : '' }}">
                ...
                <div class="carousel-content">
                    ...
                    <a href="{{ route($slide['buttonLink']) }}" class="btn hero-button">{{ __($slide['buttonText']) }}</a>
                </div>
            </div>
        @endforeach
    </div>
    ...
    <div class="container py-5">
        ...
        <div class="row mt-4">
            <div class="col-12 text-center">
                <a href="{{ route('products') }}" class="btn log-in-button">{{__('ui.showMore')}}</a>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                @foreach ($reviews as $review)
                    <div class="col-md-6 col-lg-3 mb-4">
                        <div class="review-card h-100 shadow-sm rounded bg-white p-4">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center align-items-stretch">
                <div class="col-md-4 mb-4">
                    <div class="benefit-card text-center p-4 rounded shadow h-100 bg-light">
            ...
            <div class="text-center mt-5">
                <a href="{{ route('products') }}" class="btn log-in-button btn-lg">{{__('ui.exploreAds')}}</a>
            </div>
        </div>
    </section>
</x-layout>
